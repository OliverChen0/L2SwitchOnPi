...
/*                      ALL RIGHTS RESERVED                             */
/************************************************************************/
#ifndef __MRDC_ICLI_TYPE_H__
#define __MRDC_ICLI_TYPE_H__
//****************************************************************************
/*
==============================================================================
...
typedef struct {
    union {
        mrdc_ip_t           u_ipv4_addr;
        mrdc_ipv6_t         u_ipv6_addr;
...
typedef enum {
    ...
    ICLI_VARIABLE_LOOPBACK_ID,
    ICLI_VARIABLE_VLAN_LIST, // 40,
    ICLI_VARIABLE_VLINK_LIST, 
    ...
    ICLI_VARIABLE_URL,
    ICLI_VARIABLE_FILE,
    ICLI_VARIABLE_URL_FILE, // 60
    ICLI_VARIABLE_NET_ADDR, 
...
typedef struct {
    union {
        mrdc_mac_t                  u_mac_addr;         // ICLI_VARIABLE_MAC_ADDR
        mrdc_mac_t                  u_mac_ucast;        // ICLI_VARIABLE_MAC_UCAST
        mrdc_mac_t                  u_mac_mcast;        // ICLI_VARIABLE_MAC_MCAST
        mrdc_ip_t                   u_ipv4_addr;        // ICLI_VARIABLE_IPV4_ADDR
        mrdc_ip_t                   u_ipv4_netmask;     // ICLI_VARIABLE_IPV4_NETMASK
        mrdc_ip_t                   u_ipv4_wildcard;    // ICLI_VARIABLE_IPV4_WILDCARD
        mrdc_ip_t                   u_ipv4_ucast;       // ICLI_VARIABLE_IPV4_UCAST
        mrdc_ip_t                   u_ipv4_mcast;       // ICLI_VARIABLE_IPV4_MCAST
        mrdc_ip_t                   u_ipv4_nmcast;      // ICLI_VARIABLE_IPV4_NMCAST
        mrdc_ip_t                   u_ipv4_abc;         // ICLI_VARIABLE_IPV4_ABC
        icli_ipv4_subnet_t          u_ipv4_subnet;      // ICLI_VARIABLE_IPV4_SUBNET
        u32                         u_ipv4_prefix;      // ICLI_VARIABLE_IPV4_PREFIX
        mrdc_ipv6_t                 u_ipv6_addr;        // ICLI_VARIABLE_IPV6_ADDR
        mrdc_ipv6_t                 u_ipv6_netmask;     // ICLI_VARIABLE_IPV6_NETMASK
        mrdc_ipv6_t                 u_ipv6_ucast;       // ICLI_VARIABLE_IPV6_UCAST
        mrdc_ipv6_t                 u_ipv6_mcast;       // ICLI_VARIABLE_IPV6_MCAST
        mrdc_ipv6_t                 u_ipv6_linklocal;   // ICLI_VARIABLE_IPV6_LINKLOCAL
        mrdc_ipv6_network_t         u_ipv6_subnet;      // ICLI_VARIABLE_IPV6_SUBNET
        ...
        u32                         u_loopback_id;      // ICLI_VARIABLE_LOOPBACK_ID
        ...
        mrdc_ip_t                   u_area_id;          // ICLI_VARIABLE_AREA_ID
...
typedef mrdc_rc (*icli_multiline_callback_t)(char *);
