...
)
{
    ...
    /* check length */
    if (mrdc_icli_str_len(sub) > mrdc_icli_str_len(s)) {
        return NULL;
    }
    len = mrdc_icli_str_len(s) - mrdc_icli_str_len(sub) + 1;
...
/*
    ...
    RETURN
        icli_ipv4_class_t
*/
icli_ipv4_class_t mrdc_icli_ipv4_class_get(
    IN  mrdc_ip_t   ip
)
{
    u32     i;
...
/*
    ...
    RETURN
        ...
        FALSE - failed
*/
BOOL mrdc_icli_ipv4_prefix_to_netmask(
    IN  u32         prefix,
...
/*
    ...
    RETURN
        ...
        FALSE - failed
*/
BOOL mrdc_icli_ipv4_netmask_to_prefix(
    IN   mrdc_ip_t   netmask,
    OUT  u32         *prefix
)
{
    u32         i;
    ...
    if ( netmask == 0 ) {
        *prefix = 0;
        ...
        for ( i = 1; i <= 32; ++i ) {
            if ( mrdc_icli_ipv4_prefix_to_netmask(i, &n) ) {
                if ( netmask == n ) {
                    *prefix = i;
                    return TRUE;
                }
...
/*
    ...
    RETURN
        ...
        FALSE - failed
*/
BOOL mrdc_icli_ipv6_netmask_to_prefix(
    IN   mrdc_ipv6_t    *netmask,
    OUT  u32            *prefix
)
{
    u32     i;
...
/*
    IPv6 address: mrdc_ipv6_t to string
...
/*
    ...
    RETURN
        ...
        NULL : failed
*/
char *mrdc_icli_switch_port_range_to_str(
...
)
{
    ...
    c = s;
    (void)mrdc_icli_str_cpy(c, mrdc_icli_variable_port_type_get_name(spr->port_type));
    c = c + mrdc_icli_str_len(c);
    (void)mrdc_icli_str_cpy(c, " ");
    ++c;
...
/*
    ...
    RETURN
        ...
        NULL : failed
*/
char *mrdc_icli_stack_port_range_to_str(
...
)
{
    ...
    for (i = 0; i < spr->cnt; ++i) {
        ...
        (void)mrdc_icli_switch_port_range_to_str(&(spr->switch_range[i]), c);
        c = c + mrdc_icli_str_len(c);
    }
...
/*
    ...
    RETURN
        ...
        NULL : failed
*/
char *mrdc_icli_unsigned_range_to_str(
...
/*
    ...
    RETURN
        ...
        NULL : failed
*/
char *mrdc_icli_signed_range_to_str(
...
)
{
    ...
    if (r->type == ICLI_RANGE_TYPE_SIGNED) {
        (void)mrdc_icli_signed_range_to_str(&(r->u.sr), c);
    } else {
        (void)mrdc_icli_unsigned_range_to_str(&(r->u.ur), c);
    }
...
/*
    ...
    RETURN
        ...
        NULL : failed
*/
char *mrdc_icli_clock_id_to_str(
...
)
{
    ...
    len = mrdc_icli_str_len( file_name );
