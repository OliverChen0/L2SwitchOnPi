...
==============================================================================
*/
#define MRDC_ICLI_RC(expr)   { i32 __rc__ = (expr); if (__rc__ != ICLI_RC_OK) return __rc__; }
...
#define ICLI_RC_CHECK(rc, msg) \
    if ( icli_session_rc_check(session_id, rc, msg) != MRDC_RC_OK ) { \
...
#define ICLI_RC_CHECK_PRINT_RC(rc) \
    {                                                                                       \
        mrdc_rc __rc__ = (rc);                                                              \
        if ( icli_session_rc_check(session_id, __rc__, NULL) != MRDC_RC_OK ) { \
           return ICLI_RC_ERROR;                                                            \
        }                                                                                   \
    }
...
==============================================================================
*/
#define icli_to_upper_case              mrdc_icli_to_upper_case
#define icli_to_lower_case              mrdc_icli_to_lower_case
#define icli_str_len                    mrdc_icli_str_len
#define icli_str_cpy                    mrdc_icli_str_cpy
#define icli_str_ncpy                   mrdc_icli_str_ncpy
#define icli_str_cmp                    mrdc_icli_str_cmp
#define icli_str_sub                    mrdc_icli_str_sub
#define icli_str_concat                 mrdc_icli_str_concat
#define icli_str_str                    mrdc_icli_str_str
#define icli_ipv4_to_str                mrdc_icli_ipv4_to_str
#define icli_ipv4_class_get             mrdc_icli_ipv4_class_get
#define icli_ipv4_prefix_to_netmask     mrdc_icli_ipv4_prefix_to_netmask
#define icli_ipv4_netmask_to_prefix     mrdc_icli_ipv4_netmask_to_prefix
#define icli_ipv6_netmask_to_prefix     mrdc_icli_ipv6_netmask_to_prefix
#define icli_ipv6_to_str                mrdc_icli_ipv6_to_str
#define icli_mac_to_str                 mrdc_icli_mac_to_str
#define icli_str_to_int                 mrdc_icli_str_to_int
#define icli_str_prefix                 mrdc_icli_str_prefix
#define icli_switch_port_range_to_str   mrdc_icli_switch_port_range_to_str
#define icli_stack_port_range_to_str    mrdc_icli_stack_port_range_to_str
#define icli_unsigned_range_to_str      mrdc_icli_unsigned_range_to_str
#define icli_signed_range_to_str        mrdc_icli_signed_range_to_str
#define icli_range_to_str               mrdc_icli_range_to_str
#define icli_oui_to_str                 mrdc_icli_oui_to_str
#define icli_clock_id_to_str            mrdc_icli_clock_id_to_str
#define icli_vcap_vr_to_str             mrdc_icli_vcap_vr_to_str
#define icli_hexval_to_str              mrdc_icli_hexval_to_str
#define icli_file_name_check            mrdc_icli_file_name_check
