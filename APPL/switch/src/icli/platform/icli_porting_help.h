...
#define ICLI_HELP_DDMI              "Digital Diagnostics Monitoring Interface"
/* E */
...
#define ICLI_HELP_IRDP              "ICMP Router Discovery Protocol (IRDP)"
...
#define ICLI_HELP_NPI               "Network packet interface"
/* O */
...
#define ICLI_HELP_PORT_TYPE_ID      "Port type and port ID"
...
#define ICLI_HELP_PORT_MONITOR_CONDITION   "Configure the Port Monitor condition settings"
#define ICLI_HELP_PORT_MONITOR_CONDITION_SPEED_DUPLEX   "Configure the link speed and duplex settings"
/* Q */
